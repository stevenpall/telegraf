...
func NewRunningOutput(
	...
	ro := &RunningOutput{
		...
		MetricsWritten:    selfstat.Register("outputs_"+name, "metrics_written", map[string]string{}),
		BufferSize:        selfstat.Register("outputs_"+name, "buffer_size", map[string]string{}),
		BufferLimit:       selfstat.Register("outputs_"+name, "buffer_limit", map[string]string{}),
		WriteTime:         selfstat.RegisterTiming("outputs_"+name, "write_time_ns", map[string]string{}),
	}
